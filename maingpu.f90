!   Capt'n OPER General for GPU
!   program for testing
!   the good stuff is in capgpu.f90
!   runs the capture code one isotope at a time, letting the user sum the total later
!   to compile this version of main, switch out 'MAIN = main.o' for 'MAIN = mainOperGPU.o' in the make file (line 8)
